              ...
              <div className="flex justify-between items-center">
                {stockLevelBar ? (
                  <div className=" flex w-3/4  overflow-hidden h-3 rounded-full ">
                    <div
                      className={`bg-[#660066]  h-full `}
                      style={inStock}
                    ></div>
                    <div
                      className={`bg-[#BE29EC] h-full  `}
                      style={lowStock}
                    ></div>
                    <div
                      className={`bg-[#EFBBFF] h-full  `}
                      style={outOfStock}
                    ></div>
                  </div>
                ) : null}
                        ...
                        <tr key={e.id} className=" border-b hover:bg-white/10 ">
                          ...
                          <td className="px-6 py-4  text-center">
                            {e.stock_levle == "In Stock" ? (
                              <div className="bg-[#660066] border-2 bg-opacity-30  border-[#660066] p-3 px-2 rounded-full">
                                {e.stock_levle}
                              </div>
                            ) : e.stock_levle == "Low Stock" ? (
                              <div className="bg-[#BE29EC] border-2 bg-opacity-30 text-white border-[#BE29EC] p-3 px-2 rounded-full">
                                {e.stock_levle}
                              </div>
                            ) : (
                              <div className="bg-[#EFBBFF] text-white border-2 bg-opacity-30 border-[#EFBBFF] p-3 px-2 rounded-full">
                                {e.stock_levle}
                              </div>
                            )}
                          </td>
